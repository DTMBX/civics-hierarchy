...
export function SiteFooter({ userId }: SiteFooterProps) {
  ...
  return (
    <>
      <footer className="bg-card border-t border-border print:break-before-page">
        {/* ── Primary legal bar ─────────────────────────────────── */}
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-3">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-foreground/70 dark:text-foreground/60 leading-relaxed mt-1">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4 text-xs text-muted-foreground leading-relaxed">
            <div className="space-y-1.5">
              <h4 className="font-semibold text-foreground/80 dark:text-foreground/70 flex items-center gap-1.5 uppercase tracking-wider text-[11px]">
                <Scales className="w-3.5 h-3.5" weight="fill" />
